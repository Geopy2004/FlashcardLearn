...
import '../flashcards/science_flashcard.dart'; // Import the Science flashcard data
...
class _SciencePageState extends State<SciencePage>
  ...
  void _showNextCard() {
    setState(() {
      if (_currentIndex < scienceFlashcard.length - 1) {
        _currentIndex++;
      }
    });
  }
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: 10),
            Text(
              'Review and test your Science knowledge!',
            ...
            // Flashcard
            Flashcard(
              question: scienceFlashcard[_currentIndex]['question']!,
              answer: scienceFlashcard[_currentIndex]['answer']!,
            ),
            SizedBox(height: 20),
            ...
            Row(
              ...
              children: [
                ...
                SizedBox(width: 20),
                ElevatedButton(
                  onPressed: _currentIndex < scienceFlashcard.length - 1
                      ? _showNextCard
                      : null,
                  style: ElevatedButton.styleFrom(
                    backgroundColor: Colors.green.shade400,
              ...
              children: [
                Text(
                  ...
                  style: TextStyle(
                    ...
                    color: _showAnswer ? Colors.green.shade700 : Colors.black87,
                  ),
                ),
                SizedBox(height: 10),
                Text(
