...
import '../flashcards/history_flashcard_data.dart';
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: 10),
            Text(
              'Review and test your History knowledge!',
            ...
            // Flashcard
            Flashcard(
              question: historyFlashcards[_currentIndex]['question']!,
              answer: historyFlashcards[_currentIndex]['answer']!,
            ),
            SizedBox(height: 20),
            ...
            Row(
              ...
              children: [
                ...
                SizedBox(width: 20),
                ElevatedButton(
                  onPressed: _currentIndex < historyFlashcards.length - 1
                      ? _showNextCard
                      : null,
                  style: ElevatedButton.styleFrom(
                    backgroundColor: Colors.red.shade400,
