...
class _EnglishQuizPageState extends State<EnglishQuizPage> {
  final List<Map<String, dynamic>> englishFlashcards = getFormattedQuizData();
  int _currentIndex = 0;
  int _score = 0;
  ...
  void _nextQuestion() {
    if (_currentIndex >= englishFlashcards.length - 1) {
      _endQuiz();
      return;
    }
